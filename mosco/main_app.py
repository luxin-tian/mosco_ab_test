...
def home(homepage_path, privacy_path, contact_path):
    '''The home page. '''
    st.error('''We STAND AGAINST any intentional racial/sexual discrimination that is resulted from data-driven decision making. [Read more about the humanity side](https://news.cornell.edu/stories/2019/02/social-scientists-take-data-driven-discrimination)''')
